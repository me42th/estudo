...
class DavidMeth {
    ...
    public static void main(String[] args) throws Exception {
      ...
      explosion();
       ...
       walkRight(15, 
               new String[]{
             "Estava encapsulado no pc",
             "Estava encapsulado no pc",      
             "O BUG me libertou",
             "O BUG me libertou",
             "Sou o avatar de David Meth",
             "Sou o avatar de David Meth",
             "Sou o me42th",
             "Sou o me42th",
             "Sou o responsavel pela \"TAREFA\"",
             "Sou o responsavel pela \"TAREFA\"",
             "Demonstrarei porque David deve ser escolhido",
             "Demonstrarei porque David deve ser escolhido",
             "Para integrar o Time Solutis"
         } );
       ...
       talk(
               new String[]{
               "Há, primeiramente, vontade pessoal",
              }
       );
       rightSpace[0] = "\t\tSKILLS";
       talk(
       ...
       walkLeft(3,
               new String[]{
                   "de apontar para o objeto, ops :), objetivo correto",
                   "de apontar para o objeto, ops :), objetivo correto",                                 
        ...
        talk(
                new String[]{
                   "de passar num teste instanceof programador",
                }
        );
        rightSpace[1] = "\t\t\t Logica";
        talk(
                new String[]{
                   "de passar num teste instanceof programador" ,
                   "ao inves de referenciar outro subtipo de TI",
                   "ao inves de referenciar outro subtipo de TI",
        ...
        walkRight(1,new String[]{
                    "David batalhou e estudando sozinho",
                    
                    }
        );
        rightSpace[3] = "\t\t\t Persistencia";
        ...
        talk(
                new String[]{
                    "Na época David residia em Juazeiro",
                    "Na época David residia em Juazeiro",
        ...
        talk(
                new String[]{
                    "o mercado nao era facil por la",
                }
        );
        rightSpace[4] = "";
        talk(
        ...
        talk(   
                new String[]{
                    "Por isso, tenta a sorte em Salvador",
        ...
        walkLeft(1,new String[]{
                "E aqui ele busca alguma oportunidade valorosa",
                              
            }
        );
        rightSpace[2] = "\t\tVALORES";
        walkLeft(1,new String[]{
                "E aqui ele busca alguma oportunidade valorosa",
        ...
        walkLeft(1,new String[]{
                "Numa empresa que valorize a criatividade",
                              
            }
        );
        rightSpace[3] = "\t\t\tOUSADIA ";
        walkLeft(1,new String[]{
                "Numa empresa que valorize a criatividade",
        ...
        walkLeft(1,new String[]{
                "Onde conhecimento seja bem visto",
                              
            }
        );
        rightSpace[3] += "ENTUSIASMO ";
        walkLeft(1,new String[]{
                "Onde conhecimento seja bem visto",
        ...
        walkLeft(1,new String[]{
                "Que procura desafios a serem solucionados"              
            }               
        );
        rightSpace[3] += "ATITUDE";
        walkRight(1,new String[]{
                "Que procura desafios a serem solucionados"              
            }                
        );
        rightSpace[4]+= "\t\t\tOBJETIVO ";
        talk(new String[]{
                "...",
            }                
        );
        rightSpace[4]+= "TENACIDADE ";
        talk(new String[]{
                "!",
            }                
        );
        ...
        walkLeft(1,new String[]{
                "Esses sao os motivos de David ser ",
        ...
        walkRight(3,new String[]{
                "uma boa escolha para esta vaga",
                "uma boa escolha para esta vaga",
                "(:"
            }                
        );
